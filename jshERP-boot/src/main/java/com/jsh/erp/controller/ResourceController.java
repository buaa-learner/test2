...
public class ResourceController {
  ...
  @Resource private CommonQueryManager configResourceManager;
  ...
  @DeleteMapping(
      value = "/{apiName}/deleteBatch",
      produces = {"application/javascript", "application/json"})
  @ApiOperation(value = "批量删除")
  public String batchDeleteResource(
      @PathVariable("apiName") String apiName,
  ...
  public String checkIsNameExist(
      @PathVariable("apiName") String apiName,
