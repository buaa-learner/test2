...
public class PlatformConfigController {
  ...
  @Resource private PlatformConfigService platformConfigService;
  ...
  public String updatePlatformConfigByKey(
      @RequestBody JSONObject object, HttpServletRequest request) throws Exception {
  ...
  public BaseResponseInfo getPlatformConfigByKey(
      @RequestParam("platformKey") String platformKey, HttpServletRequest request)
      throws Exception {
