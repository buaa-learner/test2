...
public class UserController {
  ...
  private static final String BASE_CHECK_CODES =
      "qwertyuiplkjhgfdsazxcvbnmQWERTYUPLKJHGFDSAZXCVBNM1234567890";

  @PostMapping(value = "/login")
  @ApiOperation(value = "登录")
  public BaseResponseInfo login(@RequestBody User userParam, HttpServletRequest request)
      throws Exception {
    ...
    try {
      ...
      if (user != null) {
        ...
        logService.insertLogWithUserId(
            user.getId(),
            user.getTenantId(),
            "用户",
            new StringBuffer(BusinessConstants.LOG_OPERATION_TYPE_LOGIN)
  ...
  public String resetPwd(@RequestBody JSONObject jsonObject, HttpServletRequest request)
      throws Exception {
  ...
  public String updatePwd(@RequestBody JSONObject jsonObject, HttpServletRequest request)
      throws Exception {
    Integer flag = 0;
  ...
  /**
   * create by: cjl description: 新增用户及机构和用户关系 create time: 2019/3/8 16:06 @Param: beanJson
   *
  ...
  public Object addUser(@RequestBody JSONObject obj, HttpServletRequest request) throws Exception {
    ...
    if (count >= userNumLimit) {
      throw new BusinessParamCheckingException(
          ExceptionConstants.USER_OVER_LIMIT_FAILED_CODE,
  ...
  /**
   * create by: cjl description: 修改用户及机构和用户关系 create time: 2019/3/8 16:06 @Param: beanJson
   *
   * @return java.lang.Object
   */
  ...
  @ResponseBody
  public Object updateUser(@RequestBody JSONObject obj, HttpServletRequest request)
      throws Exception {
    JSONObject result = ExceptionConstants.standardSuccess();
    UserEx ue = JSONObject.parseObject(obj.toJSONString(), UserEx.class);
