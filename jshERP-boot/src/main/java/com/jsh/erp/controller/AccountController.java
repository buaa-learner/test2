...
public class AccountController {
  ...
  public BaseResponseInfo findAccountInOutList(
    ...
    Map<String, Object> map = new HashMap<String, Object>();
    try {
      List<AccountVo4InOutList> dataList =
          accountService.findAccountInOutList(accountId, (currentPage - 1) * pageSize, pageSize);
      ...
      if (null != dataList) {
        ...
        for (AccountVo4InOutList aEx : dataList) {
          ...
          BigDecimal balance =
              accountService
                  .getAccountSum(accountId, timeStr, "date", forceFlag)
                  .add(accountService.getAccountSumByHead(accountId, timeStr, "date", forceFlag))
                  .add(accountService.getAccountSumByDetail(accountId, timeStr, "date", forceFlag))
                  .add(accountService.getManyAccountSum(accountId, timeStr, "date", forceFlag))
                  .add(initialAmount);
  ...
  public String updateIsDefault(@RequestBody JSONObject object, HttpServletRequest request)
      throws Exception {
  ...
  public BaseResponseInfo getStatistics(
