...
public class MsgController {
  ...
  public BaseResponseInfo getMsgByStatus(
  ...
  public BaseResponseInfo batchUpdateStatus(
  ...
  public BaseResponseInfo getMsgCountByStatus(
      @RequestParam("status") String status, HttpServletRequest request) throws Exception {
    BaseResponseInfo res = new BaseResponseInfo();
    try {
  ...
  public BaseResponseInfo getMsgCountByType(
