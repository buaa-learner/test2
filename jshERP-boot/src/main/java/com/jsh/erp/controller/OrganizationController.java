...
/**
 * create by: cjl description:
 *
 * <p>create time: 2019/3/6 10:54
 */
@RestController
...
public class OrganizationController {
  ...
  /**
   * create by: cjl description: 获取机构树数据 create time: 2019/2/19 11:49 @Param:
   *
  ...
  /**
   * create by: cjl description: 新增机构信息 create time: 2019/2/19 17:17 @Param: beanJson
   *
  ...
  public Object addOrganization(@RequestParam("info") String beanJson) throws Exception {
    ...
    if (i < 1) {
      throw new BusinessRunTimeException(
          ExceptionConstants.ORGANIZATION_ADD_FAILED_CODE,
          ExceptionConstants.ORGANIZATION_ADD_FAILED_MSG);
    }
    return result;
  }
  /**
   * create by: cjl description: 修改机构信息 create time: 2019/2/20 9:30 @Param: beanJson
   *
   * @return java.lang.Object
   */
  ...
  public Object editOrganization(@RequestParam("info") String beanJson) throws Exception {
    ...
    if (i < 1) {
      throw new BusinessRunTimeException(
          ExceptionConstants.ORGANIZATION_EDIT_FAILED_CODE,
