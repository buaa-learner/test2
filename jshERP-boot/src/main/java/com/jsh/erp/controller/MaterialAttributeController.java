...
public class MaterialAttributeController {
  ...
  @Resource private MaterialAttributeService materialAttributeService;
  ...
  public JSONArray getNameList(HttpServletRequest request) throws Exception {
    ...
    try {
      List<MaterialAttribute> materialAttributeList =
          materialAttributeService.getMaterialAttribute();
  ...
  public JSONArray getValueListById(@RequestParam("id") Long id, HttpServletRequest request)
      throws Exception {
    JSONArray dataArray = new JSONArray();
    try {
