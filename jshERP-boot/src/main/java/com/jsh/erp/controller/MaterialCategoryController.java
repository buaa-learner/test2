...
public class MaterialCategoryController {
  ...
  public BaseResponseInfo getAllList(
      @RequestParam("parentId") Long parentId, HttpServletRequest request) throws Exception {
    ...
    try {
      ...
      if (null != dataList) {
        for (MaterialCategory mc : dataList) {
          ...
          List<MaterialCategory> dataParentList =
              materialCategoryService.findById(mc.getParentId());
  ...
  /**
   * create by: cjl description: 获取商品类别树数据 create time: 2019/2/19 11:49 @Param:
   *
  ...
  /**
   * create by: cjl description: 新增商品类别数据 create time: 2019/2/19 17:17 @Param: beanJson
   *
  ...
  public Object addMaterialCategory(@RequestParam("info") String beanJson) throws Exception {
    ...
    if (i < 1) {
      throw new BusinessRunTimeException(
          ExceptionConstants.MATERIAL_CATEGORY_ADD_FAILED_CODE,
          ExceptionConstants.MATERIAL_CATEGORY_ADD_FAILED_MSG);
    }
    return result;
  }
  /**
   * create by: cjl description: 修改商品类别数据 create time: 2019/2/20 9:30 @Param: beanJson
   *
   * @return java.lang.Object
   */
  ...
  public Object editMaterialCategory(@RequestParam("info") String beanJson) throws Exception {
    ...
    if (i < 1) {
      throw new BusinessRunTimeException(
          ExceptionConstants.MATERIAL_CATEGORY_EDIT_FAILED_CODE,
