...
/**
 * @ClassName:BusinessConstants @Description 业务字典类 @Author qiankunpingtai @Date 2019-3-6
 * 17:58 @Version 1.0
 */
public class BusinessConstants {
  ...
  /** 单据主表出入库类型 type 入库 出库 其它 depothead */
  ...
  /** 出入库分类 采购、采购退货、其它、零售、销售、调拨、盘点复盘等 */
