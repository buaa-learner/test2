...
public class StringUtil {
  ...
  public static final String regex =
      "'|#|%|;|--| and | and|and | or | or|or | not | not|not | use | use|use | insert |"
          + " insert|insert | delete | delete|delete | update | update|update | select |"
          + " select|select | count | count|count | group | group|group | union | union|union |"
          + " create | create|create | drop | drop|drop | truncate | truncate|truncate | alter |"
          + " alter|alter | grant | grant|grant | execute | execute|execute | exec | exec|exec |"
          + " xp_cmdshell | xp_cmdshell|xp_cmdshell | call | call|call | declare | declare|declare"
          + " | source | source|source | sql | sql|sql ";
  ...
  /**
   * String字符串转成List<Long>数据格式 String str = "1,2,3,4,5,6" -> List<Long> listLong [1,2,3,4,5,6];
   *
   * @param strArr
   * @return
   */
  ...
  /**
   * String字符串转成List<BigDecimal>数据格式 String str = "1,2,3,4,5,6" -> List<BigDecimal> listBigDecimal
   * [1,2,3,4,5,6];
   *
   * @param strArr
   * @return
  ...
  /**
   * String字符串转成List<String>数据格式 String str = "1,2,3,4,5,6" -> List<Long> listLong [1,2,3,4,5,6];
   *
   * @param strArr
   * @return
   */
