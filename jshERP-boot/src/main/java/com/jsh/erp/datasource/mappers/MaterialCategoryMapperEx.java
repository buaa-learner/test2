...
/** Description @Author: cjl @Date: 2019/2/18 17:23 */
public interface MaterialCategoryMapperEx {
  ...
  Long countsByMaterialCategory(@Param("name") String name, @Param("parentId") Integer parentId);
  ...
  int batchDeleteMaterialCategoryByIds(
  ...
  List<MaterialCategory> getMaterialCategoryBySerialNo(
      @Param("serialNo") String serialNo, @Param("id") Long id);

  List<MaterialCategory> getMaterialCategoryListByCategoryIds(
      @Param("parentIds") String[] categoryIds);
