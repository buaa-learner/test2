...
public interface UserMapperEx {
  ...
  Long countsByUser(@Param("userName") String userName, @Param("loginName") String loginName);

  List<User> getUserListByUserNameOrLoginName(
  ...
  List<User> getListByOrgaId(@Param("id") Long id, @Param("orgaId") Long orgaId);
}
