...
/** Description @Author: cjl @Date: 2019/1/22 14:54 */
public interface MaterialMapperEx {
  ...
  List<MaterialVo4Unit> findBySelectWithBarCode(
      @Param("idList") List<Long> idList,
      @Param("q") String q,
      @Param("enableSerialNumber") String enableSerialNumber,
      @Param("enableBatchNumber") String enableBatchNumber,
  ...
  int findBySelectWithBarCodeCount(
      @Param("idList") List<Long> idList,
      @Param("q") String q,
      @Param("enableSerialNumber") String enableSerialNumber,
      @Param("enableBatchNumber") String enableBatchNumber);
  ...
  /** 获取开启序列号并且状态正常的商品列表 */
  List<MaterialVo4Unit> getMaterialEnableSerialNumberList(
      @Param("q") String q, @Param("offset") Integer offset, @Param("rows") Integer rows);

  Long getMaterialEnableSerialNumberCount(@Param("q") String q);

  int batchDeleteMaterialByIds(
  ...
  List<MaterialVo4Unit> getMaterialByMeId(@Param("meId") Long meId);
  ...
  List<MaterialVo4Unit> getMaterialByBarCodeAndWithOutMId(
      @Param("barCodeArray") String[] barCodeArray, @Param("mId") Long mId);
