...
/** Description @Author: cjl @Date: 2019/1/25 14:50 */
public interface DepotHeadMapperEx {
  ...
  List<MaterialsListVo> findMaterialsListMapByHeaderIdList(@Param("idList") List<Long> idList);

  List<MaterialCountVo> getMaterialCountListByHeaderIdList(@Param("idList") List<Long> idList);
  ...
  List<DepotHeadVo4List> getDetailByNumber(@Param("number") String number);

  int batchDeleteDepotHeadByIds(
  ...
  List<FinishDepositVo> getFinishDepositByNumberList(@Param("numberList") List<String> numberList);

  BigDecimal getFinishDepositByNumberExceptCurrent(
      @Param("linkNumber") String linkNumber, @Param("number") String number);
}
