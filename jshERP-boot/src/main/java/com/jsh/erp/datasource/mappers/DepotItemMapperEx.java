...
/** Description @Author: cjl @Date: 2019/1/24 16:59 */
public interface DepotItemMapperEx {
  ...
  int findByAllCount(
      @Param("materialParam") String materialParam, @Param("endTime") String endTime);
  ...
  int findStockWarningCountTotal(
      @Param("materialParam") String materialParam, @Param("depotList") List<Long> depotList);
  ...
  Long getCountByMaterialAndDepot(@Param("mId") Long mId, @Param("depotId") Long depotId);
  ...
  List<DepotItemVo4MaterialAndSum> getBatchBillDetailMaterialSum(
      @Param("linkNumber") String linkNumber, @Param("type") String type);

  Long getCountByMaterialAndBatchNumber(
      @Param("meId") Long meId, @Param("batchNumber") String batchNumber);

  List<DepotItem> getDepotItemByBatchNumber(@Param("batchNumber") String batchNumber);
}
