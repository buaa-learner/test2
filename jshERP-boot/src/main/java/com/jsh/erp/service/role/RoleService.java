...
public class RoleService {
  ...
  @Resource private RoleMapperEx roleMapperEx;
      ...
      for (RoleEx roleEx : list) {
        ...
        if (StringUtil.isNotEmpty(priceLimit)) {
          String priceLimitStr =
              priceLimit.replace("1", "屏蔽采购价").replace("2", "屏蔽零售价").replace("3", "屏蔽销售价");
  ...
  /**
   * create by: qiankunpingtai 逻辑删除角色信息 create time: 2019/3/28 15:44 @Param: ids
   *
   * @return int
   */
  @Transactional(value = "transactionManager", rollbackFor = Exception.class)
  public int batchDeleteRoleByIds(String ids) throws Exception {
    ...
    try {
      result =
          roleMapperEx.batchDeleteRoleByIds(
   ...
   * @return
   */
  public Object parsePriceByLimit(
      BigDecimal price, String type, String emptyInfo, HttpServletRequest request)
      throws Exception {
