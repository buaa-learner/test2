 ...
 * Description
 *
 * @author jisheng hua @Date: 2021/1/28 18:10
 */
@Component
public class RedisService {
  ...
  /**
   * @author jisheng hua description: 从session中获取信息
   * @date: 2021/1/28 18:10 @Param: request @Param: key
   * @return Object
   */
  ...
  /**
   * @author jisheng hua description: 将信息放入session或者redis中
   * @date: 2021/1/28 18:10 @Param: request @Param: key @Param: obj
   * @return
   */
  ...
  /**
   * @author jisheng hua description: 将信息从session或者redis中移除
   * @date: 2021/1/28 18:10 @Param: request @Param: key @Param: obj
   * @return
   */
  ...
  /**
   * @author jisheng hua 将信息从redis中移除，比对user和ip
   * @param userId
   * @param clientIp
   */
  public void deleteObjectByUserAndIp(Long userId, String clientIp) {
    ...
    for (String token : tokens) {
      ...
      if (userIdValue != null
          && clientIpValue != null
          && userIdValue.equals(userId.toString())
          && clientIpValue.equals(clientIp)) {
