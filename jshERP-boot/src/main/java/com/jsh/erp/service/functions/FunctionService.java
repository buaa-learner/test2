...
public class FunctionService {
  ...
  @Resource private FunctionMapper functionsMapper;

  @Resource private FunctionMapperEx functionMapperEx;
  ...
  public int batchDeleteFunctionByIds(String ids) throws Exception {
    ...
    try {
      if (BusinessConstants.DEFAULT_MANAGER.equals(userService.getCurrentUser().getLoginName())) {
        result =
            functionMapperEx.batchDeleteFunctionByIds(
