...
/** Description @Author: cjl @Date: 2019/3/11 18:11 */
@Service
public class OrgaUserRelService {
  private Logger logger = LoggerFactory.getLogger(OrganizationService.class);

  @Resource private OrgaUserRelMapper orgaUserRelMapper;
  @Resource private OrgaUserRelMapperEx orgaUserRelMapperEx;
  ...
  /**
   * create by: cjl description: 新增机构用户关联关系,反显id create time: 2019/3/12 9:40 @Param: orgaUserRel
   *
   * @return void
   */
  @Transactional(value = "transactionManager", rollbackFor = Exception.class)
  ...
  /**
   * create by: cjl description: 更新机构用户关联关系 create time: 2019/3/12 9:40 @Param: orgaUserRel
   *
   * @return void
   */
  @Transactional(value = "transactionManager", rollbackFor = Exception.class)
