...
public class AccountService {
  ...
  @Resource private AccountMapperEx accountMapperEx;

  @Resource private DepotHeadMapper depotHeadMapper;
  @Resource private DepotHeadMapperEx depotHeadMapperEx;

  @Resource private AccountHeadMapper accountHeadMapper;
  ...
  public List<AccountVo4List> select(
      String name, String serialNo, String remark, int offset, int rows) throws Exception {
    ...
    if (null != list && null != timeStr) {
      for (AccountVo4List al : list) {
        ...
        BigDecimal currentAmount =
            getAccountSum(al.getId(), "", "month", forceFlag)
  ...
  public int batchDeleteAccountByIds(String ids) throws Exception {
    ...
    try {
      result =
          accountMapperEx.batchDeleteAccountByIds(
  ...
  public BigDecimal getAccountSum(Long id, String timeStr, String type, Boolean forceFlag)
    ...
    try {
      ...
      if (!timeStr.equals("")) {
        Date bTime =
            StringUtil.getDateByString(
                Tools.firstDayOfMonth(timeStr) + BusinessConstants.DAY_FIRST_TIME, null);
        Date eTime =
            StringUtil.getDateByString(
                Tools.lastDayOfMonth(timeStr) + BusinessConstants.DAY_LAST_TIME, null);
        Date mTime =
            StringUtil.getDateByString(
                Tools.firstDayOfMonth(timeStr) + BusinessConstants.DAY_FIRST_TIME, null);
        if (type.equals("month")) {
          criteria
              ...
              .andPayTypeNotEqualTo("预付款")
              .andOperTimeGreaterThanOrEqualTo(bTime)
              .andOperTimeLessThanOrEqualTo(eTime)
              .andDeleteFlagNotEqualTo(BusinessConstants.DELETE_FLAG_DELETED);
    ...
    try {
      ...
      if (!timeStr.equals("")) {
        ...
        if (type.equals("month")) {
          criteria
              .andAccountIdEqualTo(id)
              .andBillTimeGreaterThanOrEqualTo(bTime)
              .andBillTimeLessThanOrEqualTo(eTime)
              .andDeleteFlagNotEqualTo(BusinessConstants.DELETE_FLAG_DELETED);
        } else if (type.equals("date")) {
          criteria
              .andAccountIdEqualTo(id)
  ...
  public BigDecimal getManyAccountSum(Long id, String timeStr, String type, Boolean forceFlag)
    ...
    try {
      ...
      if (!timeStr.equals("")) {
        ...
        if (type.equals("month")) {
          criteria
              .andAccountIdListLike("%" + id.toString() + "%")
              .andOperTimeGreaterThanOrEqualTo(bTime)
              .andOperTimeLessThanOrEqualTo(eTime)
              .andDeleteFlagNotEqualTo(BusinessConstants.DELETE_FLAG_DELETED);
        } else if (type.equals("date")) {
  ...
  public List<AccountVo4InOutList> findAccountInOutList(
      Long accountId, Integer offset, Integer rows) throws Exception {
  ...
  public int updateIsDefault(Long accountId) throws Exception {
    ...
    try {
      ...
      logService.insertLog(
          "账户",
          BusinessConstants.LOG_OPERATION_TYPE_EDIT + accountId,
          ((ServletRequestAttributes) RequestContextHolder.getRequestAttributes()).getRequest());
      result = 1;
    } catch (Exception e) {
      JshException.writeFail(logger, e);
  ...
  public String getAccountStrByIdAndMoney(
      Map<Long, String> accountMap, String accountIdList, String accountMoneyList) {
    StringBuffer sb = new StringBuffer();
      ...
      if (null != list && null != timeStr) {
        for (Account a : list) {
          BigDecimal monthAmount =
              getAccountSum(a.getId(), timeStr, "month", forceFlag)
          ...
          BigDecimal currentAmount =
              getAccountSum(a.getId(), "", "month", forceFlag)
