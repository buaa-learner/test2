...
public class InOutItemService {
  ...
  @Resource private InOutItemMapper inOutItemMapper;

  @Resource private InOutItemMapperEx inOutItemMapperEx;
  ...
  public int batchDeleteInOutItemByIds(String ids) throws Exception {
    ...
    try {
      result =
          inOutItemMapperEx.batchDeleteInOutItemByIds(
