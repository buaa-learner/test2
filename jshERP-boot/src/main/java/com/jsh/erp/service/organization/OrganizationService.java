...
/** Description @Author: cjl @Date: 2019/3/6 15:10 */
@Service
public class OrganizationService {
  ...
  @Resource private OrganizationMapperEx organizationMapperEx;
  ...
  public int batchDeleteOrganizationByIds(String ids) throws Exception {
    ...
    if (organList != null && organList.size() > 0) {
      ...
      logger.error(
          "异常码[{}],异常提示[{}]",
          ExceptionConstants.ORGANIZATION_CHILD_NOT_ALLOWED_DELETE_CODE,
      ...
      result =
          organizationMapperEx.batchDeleteOrganizationByIds(
  ...
  /**
   * create by: cjl description: 检查机构编号是否已经存在 create time: 2019/3/7 10:01 @Param: orgNo
   *
   * @return void
   */
  public void checkOrgNoIsExists(String orgNo, Long id) throws Exception {
    ...
    if (orgList != null && orgList.size() > 0) {
      if (orgList.size() > 1) {
        logger.error(
            "异常码[{}],异常提示[{}],参数,orgNo[{}]",
            ExceptionConstants.ORGANIZATION_NO_ALREADY_EXISTS_CODE,
