...
public class SystemConfigService {
  ...
  @Resource private SystemConfigMapperEx systemConfigMapperEx;
    ...
    try {
      ...
      logService.insertLog(
          ...
          new StringBuffer(BusinessConstants.LOG_OPERATION_TYPE_ADD)
              .append(systemConfig.getCompanyName())
              .toString(),
          request);
    } catch (Exception e) {
  ...
  public int batchDeleteSystemConfigByIds(String ids) throws Exception {
    ...
    try {
      result =
          systemConfigMapperEx.batchDeleteSystemConfigByIds(
